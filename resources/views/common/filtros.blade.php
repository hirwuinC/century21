<section class="filterForm">
    <form action="">
        ...
        <div class="form-group">
            ...
            <select class="form-control select-2" name="propiedad" multiple="multiple">
        ...
        <div class="form-group">
            ...
            <select class="form-control select-2" name="zona[]" multiple="multiple">
        ...
        <div class="form-group">
            ...
            <select class="form-control select-2" name="hab[]" multiple="multiple">
        ...
        <div class="form-group">
            <label>Baños</label>
            <select class="form-control select-2" name="b[]" multiple="multiple">
        ...
        <div class="form-group selector">
            ...
            <select class="form-control select-2" name="est[]" multiple="multiple">
        ...
        <div class="form-group range">
            ...
            <div class="rangePrice">
                <div class="row">
                    <div class="col-xs-6">
                        <input type="text" class="form-control" name="precio_min" id="min" placeholder="Mínimo">
                    </div>
                    <div class="col-xs-6">
                        <input type="text" class="form-control" name="precio_max" id="max" placeholder="Máximo">
                    </div>
                </div>
