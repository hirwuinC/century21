				...
				@foreach($registro as $agente )
					...
					<table style="width:100%;height: 5%;font-family: verdana;font-size:small;">
						<tr style="text-align: center;background-color: #F0E482">
							...
							<td style="width: 20%;font-weight: bold;">Codigo </td>
						...
						<tr style="text-align: center; ">
							...
							<td style="width: 20%;">{{$agente['codigo']}}</td>
	...
	@else			
					 <table style="width: 99%;height: 3%;">
							...
							<td colspan="2" >
							</br></br>No se detectaron informes pendientes por enviar , por parte de los asesores.</br></br>
							</td>
						</tr>
