...
///////////////////////////////////////////////////// cargar comprador interesado ///////////////////////////////////////////////////////
	$("#compradorInteresado").validate({
      ...
      var formulario = new FormData(document.getElementById('compradorInteresado'));
			url="/compradorInteresado";
      $.ajax({
      ...
      .done(function(res){
				...
				if (res==1) {
          swal(
            'Gracias por interesarse en uno de nuestros inmuebles!!',
